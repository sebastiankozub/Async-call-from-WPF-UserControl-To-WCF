...
namespace PriceHumanizerDesktopClient
{
    ...
    public partial class AdventureWorks2017Context : DbContext
    {
        ...
        [DbFunction("AdventureWorks2017Context", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorks2017Context].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
